    ...
    return (
        <div>
            ...
            <div className="my-10 flex flex-col justify-center md:flex-row gap-20 mb-28 text-sm">
                <img src={assets.contact_image} alt="" className="w-full md:max-w-90 rounded-xl" />

                <div className="flex flex-col justify-center items-start gap-6">
                    <p className="font-semibold text-lg">Our Office</p>
                    <p className="text-muted-foreground"> 38/2083, Nai Wara, Delhi 110005, India</p>
                    ...
                    <p className="text-muted-foreground">Learn more about our teams and job openings.</p>
